...
<div class="card text-bg-light mb-3 mt-5" style="max-width: 300rem; margin:100px 300px 0 200px;">
    ...
    <div class="card-body">
        <form action="{{ route('payment.create') }}" method="POST" id="payment-form" >
            <input type="hidden" name="price" value="616000">
            @csrf
            <div class="mb-3">
            ...
            <div class="form-floating">
                ...
                <button type="submit" class="btn btn-success btn-sm mt-5" style="width: 200px; height: 50px; margin-left: 20px" data-price="616000"   id="pay-button"><b>Checkout</b></button>
        </form>
</div>
@endsection